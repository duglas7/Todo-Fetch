...
function App() {
  ...
  const getList = async (tareas) => {
    try {
      const response = await fetch('https://assets.breatheco.de/apis/fake/todos/user/duglas7');
  ...
  return (
    ...
    <div className='row d-flex justify-content-center m-5'>
      <div className=' col-md-6 contenedor pb-5'>
        ...
        <input type='text' className='form-control pt-4 pb-4 my-2' placeholder='Ingresa tu tarea' onBlur={handleOnChange}></input>
